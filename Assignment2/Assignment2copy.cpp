...
int main(int argc, char * argv[]) {
    ...
    if(inFile.good()) {
        //cout << "Opened Successfully bro" << endl;
    ...
    /*
        THINGS TO FIX (2/1):
            -For some reason, some common words like 'the' are getting into the array - DONE
            -Unique word count is off.  Might be because of common words - DONE
            -Total word count is off.  Probably also because of this crap - DONE
            -Sort function isn't sorting correctly
    */
